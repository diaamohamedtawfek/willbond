...
class UiListitem extends State<Listitem>{
...
//      fetchData();
  ...
  Future getData(var search) async {
    ...
    print(URL_LOGIC.listAllItem+"${numpage}"+"&size=15");
    isLoading = true;
    setState(() {
      isLoading = true;
//      data_offer.clear();
//      _All.clear();
    ...
    http.Response response_offer = await http.get(
        Uri.parse(URL_LOGIC.listAllItem+"${numpage}"+"&size=15")
...
//    _All.addAll(data_offer["resultData"]);
    ...
    setState(() {
      ...
      data_offer = json.decode(response_offer.body);
      if(data_offer?["status"]==null){print(data_offer?["resultData"]);
